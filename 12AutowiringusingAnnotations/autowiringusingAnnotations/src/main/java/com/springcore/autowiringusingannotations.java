...
public class autowiringusingannotations {
	
	public static void main(String[] args) {
		
		AbstractApplicationContext autowiringUsingAnnotationsBeansContext =  new ClassPathXmlApplicationContext(new String[]{"autowiringusingAnnotationsConfig.xml"});
